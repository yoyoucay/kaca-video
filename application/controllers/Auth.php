...
class Auth extends CI_Controller {
    ...
    public function kirim_email($email, $token)
    {
        ...
        $config = Array(
            ...
            'smtp_port' => 2525,
            'smtp_user' => 'd7d1408830bbc7',
            'smtp_pass' => '1bcab4dc5ca61a',
            'mailtype' => 'html',
            'crlf' => "\r\n",
            'newline' => "\r\n"
          );
        ...
        // Isi email
         $this->email->message("Klik link untuk melanjutkan verifikasi akun anda ! <a href='http://localhost/kaca2/mobileweb/verify/$email/$token'> Konfirmasi Email </a>");
    ...
    public function kirim_email_forgot($email, $token)
    {
        ...
        $this->email->subject('Authentication for registration');
        // Isi email
         $this->email->message("Klik link untuk mengubah password akun anda ! <a href='http://localhost/kaca2/mobileweb/verify_forgot/$email/$token'> Lupa Password </a>");
...
// ------------ FOLLOWING SYSTEM BY LIST FOLLOW --------------------//
    public function follow1(){
		$this->user_models->set_follow1();
		redirect('home');
    }

    public function unfollow1(){
		$this->user_models->set_unfollow1();
		redirect('home');
    }
// ------------ END ---------------------------------------------//
