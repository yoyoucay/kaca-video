                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            <img src="<?php echo base_url("assets/content/".$content_item['thumbnail_file']); ?>" class="img-fluid object-fit: cover;object-position: 100% 0;width: 500px;height: 500px;" alt="">
                            <span class="text-secondary small"><?php echo $content_item['username']; ?></span><br>
                            <span class="small font-weight-bold"><?php echo $content_item['title']; ?></span><br>
