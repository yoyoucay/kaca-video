<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <a href="http://localhost/kaca2/mobileweb/user/<?php echo $user['username']; ?>">Profile</a>
    <a href="http://localhost/kaca2/mobileweb/settings">Settings</a>
    <a href="http://localhost/kaca2/mobileweb/logout">Log out</a>
  </div>
</div>
...
<nav class="navbar fixed-top navbar-light bg-white">
    <a class="navbar-brand" href="http://localhost/kaca2/mobileweb/home">
        ...
        <?php if(@$_SESSION['logged_in'] == true){ ?>
            <img class="rounded-circle" src="
                <?php if($user['nama_avatar'] == true){ ?>
                    <?php echo base_url("assets/images/avatar/".$user['nama_avatar']); ?>
                <?php }else{ ?>
