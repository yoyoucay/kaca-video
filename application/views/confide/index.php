        ...
        <div class="col-lg-8">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="pills-image" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <div class="progress mb-2">
                                            <div class="progress-bar1 bg-color1" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="form-group mb-2">
                                    ...
                                    <div class="tab-pane fade" id="pills-video" role="tabpanel" aria-labelledby="contact-tab">
                                        ...
                                        <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                                        <div class="form-group mb-2">
                                            <input type="file" name="input_video" class="form-control-file" id="uploadFile2" id="exampleFormControlFile1">
                                        </div>
                                        <div class="progress mb-2">
                                            <div class="progress-bar2 bg-color1" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="form-group mt-2">
                                            <textarea class="form-control" name="input_deskripsi" id="exampleFormControlTextarea1"
                                                rows="3" style="max-height: 150px;min-height: 150px;" placeholder="Tulis caption videomu disini.."></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-warning my-3 btn-block">Bagikan</button>
                                        <?php echo form_close(); ?>
                                    </div>
                                </div>
                            </div>
            ...
            <ul class="list-unstyled">
                ...
                <li class="media mb-5 bg-color4 p-4 rounded-lg shadow">
                    <!-- Mulai Foto Profile -->
                    <?php if($content_item['nama_avatar'] == FALSE){ ?>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<?php echo site_url('confide/edit/'.$content_item['user_id'].'/'.$content_item['id']) ?>">Edit</a>
                            <a class="dropdown-item" href="<?php echo site_url('confide/delete/'.$content_item['id']) ?>">Delete</a>
                        </div>
                    </div>
                    <?php } ?>
                </li>
