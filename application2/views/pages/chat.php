<div class="container-fluid my-5 py-3">
    <h2>
        <b><a onclick="goBack()" class="text-dark btn btn-transparent fa fa-arrow-left"></a>Chats</b>
    </h2>
    <form class="mb-3">
    ...
    <?php foreach ($online as $on) { ?> 
        <a style="color: black; text-decoration: none;" href="<?php echo site_url('chat/'.$on['username']) ?>">
            <div class="media mb-3">
                <!-- Photo Profile -->
                <img style="object-fit:cover;width:45px;height:45px;" class="vorder mr-3 rounded-circle" src="
                <?php if($on['nama_avatar'] == true){ ?>
                <?php echo base_url("assets/images/avatar/".$on['nama_avatar']); ?>
                <?php }else{ ?>
