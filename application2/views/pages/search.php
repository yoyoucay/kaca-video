            ...
            <div class="media">
                ...
                <img class="mr-3 rounded-circle" src="
                    ...
                    if($search_show->nama_avatar == FALSE){
                        ...
                        echo base_url("assets/images/avatar/".$search_show->nama_avatar);
                    } ?>
                " alt="Generic placeholder image" style="max-width:50px;max-height:50px;">
                <!-- End Photo -->
                <div class="media-body">
                    <a href="<?php echo site_url('u/'.$search_show->username) ?>"><h6 class="mt-0 text-capitalize"><?php echo $search_show->full_name?></h6></a>
